...
- **LangChain Ecosystem**
    ...
    12. Building a research agent using a LangGraph's open source and general purpose deep agents harness
...
**Chinook - The Demo Database:**

[Chinook](https://github.com/lerocha/chinook-database) is a sample database that represents a digital media store.

Download the dabase file compatible to SQLite by executing the following command in **Anaconda Prompt** terminal.
...
You may need to move the dowloaded database file to your workspace for reference.
